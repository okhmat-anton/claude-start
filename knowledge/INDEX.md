...
- [stacks/kie-ai.md] — интеграция kie.ai: Bearer, createTask/recordInfo, ловушка «HTTP 200 с ошибкой в теле» (code != 200), ловушка №2 «не-стриминговые текстовые генерации >2 мин рубятся 500 — только SSE» (from gym-bro-2), вебхук/поллинг, билдеры пер-модель, приоритетные фото-модели (любой проект с kie.ai; from ai-video-production через business-planner)
