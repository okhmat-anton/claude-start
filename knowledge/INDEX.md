...
- [stacks/kie-ai.md] — интеграция kie.ai: Bearer, createTask/recordInfo, ловушка «HTTP 200 с ошибкой в теле» (code != 200), вебхук/поллинг, билдеры пер-модель (любой проект с kie.ai; from ai-video-production через business-planner)
